...
<html>
  <head>
    <title>Protractor Test Execution Report</title>
...
.generated-on {
  ...
  <body>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <div class="label-container">
            <span class="label label-success" title=TestCases>Passed: 1</span>
            
			
            <span class="label label-info">Time Elapsed: 0h 0min 6s</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="generated-on">2/10/2024, 11:14:37 PM</div>
	
    <!--<div class="generated-on"><b>Platform:</b> Mac OS X</div>
    <div class="info"><b>Browser:</b> chrome 121.0.6167.160</div>
    <div class="info"><b>Generated on:</b> 2/10/2024, 11:14:37 PM</div>-->
          ...
          <div class="panel-body">
            <div class="row">
              <div class="clearfix metadata col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <div class="pull-left">
                    <strong> Browser: </strong>chrome 121.0.6167.160
                  </div>
...
<div class="row">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapseSuite0">
          
            <span class="label label-success"><i class="glyphicon glyphicon-ok"></i></span>
          
          <font color="green"><b>TestSuite:</b>demo calculator tests</font>
    ...
    <div id="collapseSuite0" class="panel-collapse collapse">
            <div class="panel-body">
              
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-toggle="collapse" href="#collapseTestCase0_0">
                        
                          <span class="label label-success"><i class="glyphicon glyphicon-ok"></i></span>
                        

                        <font color="green"><b>TestCase:</b>addition test</font>
